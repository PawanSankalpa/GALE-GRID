    ...
    return (
        <div className="login-container">
            ...
            <div className="login-left">
                <h1 className="login-home" onClick={goToHome}><FiArrowLeft color="#00A389" /></h1>
            ...
            <div className="login-right">
                ...
                <form className="login-form" onSubmit={handleSubmit}>
                    ...
                    <p className="login-toregister">New Here? <a href="/register" className="login-anchor1">Register</a></p>
